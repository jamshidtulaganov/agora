...
TANDEM_APP_URL="${TANDEM_APP_URL:-${FRONTEND_ORIGIN}}"
GOOGLE_REDIRECT_URI="${GOOGLE_REDIRECT_URI:-${FRONTEND_ORIGIN}/auth/callback}"
TANDEM_SERVER_URL="${TANDEM_SERVER_URL:-ws://localhost:${PORT}/ws}"
...
export TANDEM_APP_URL GOOGLE_REDIRECT_URI TANDEM_SERVER_URL LOCAL_UPLOAD_BASE_URL
