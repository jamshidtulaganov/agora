...
import { DashboardPage } from "@tandem/views/dashboard";
import { AutopilotsPage } from "@tandem/views/autopilots/components";
import { MyIssuesPage } from "@tandem/views/my-issues";
import { SkillsPage } from "@tandem/views/skills";
import { DesktopRuntimesPage } from "./components/desktop-runtimes-page";
import { DesktopAgentsPage } from "./components/desktop-agents-page";
import { SquadsPage, SquadDetailPage as SquadDetailPageView } from "@tandem/views/squads/components";
import { InboxPage } from "@tandem/views/inbox";
import { SettingsPage } from "@tandem/views/settings";
import { useT } from "@tandem/views/i18n";
