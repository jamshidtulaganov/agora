...
const desktopAPI = {
   ...
   *  Shows a save dialog using the optional original filename and saves to
   *  disk. Unlike openExternal, this avoids browser rendering of HTML files.
   *  On non-desktop platforms this property is undefined. */
  downloadURL: (url: string, suggestedFilename?: string) =>
    ipcRenderer.invoke("file:download-url", url, suggestedFilename),
