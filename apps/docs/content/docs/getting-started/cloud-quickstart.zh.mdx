...
description: Get started with Tandem Cloud — no setup required.
---

The fastest way to get started with Tandem — no setup required.

## 1. Sign up

Go to [tandem.dev](https://tandem.dev) and create an account.
