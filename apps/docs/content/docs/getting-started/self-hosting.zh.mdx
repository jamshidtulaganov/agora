...
|----------|-------------|---------|
| `DATABASE_URL` | PostgreSQL connection string. Keep the password segment in sync with `POSTGRES_PASSWORD`. | `postgres://agora:<postgres-password>@localhost:5432/multica?sslmode=disable` |
