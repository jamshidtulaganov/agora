---
title: Contributing
description: Local development workflow for contributors working on the Agora codebase.
---
...
| | Main | Worktree |
|---|---|---|
| Database | `agora` | `multica_my_feature_702` |
...
```bash
docker compose exec -T postgres psql -U agora -d postgres \
