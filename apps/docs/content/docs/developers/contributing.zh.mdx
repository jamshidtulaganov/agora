---
title: Contributing
description: Local development workflow for contributors working on the Tandem codebase.
---
...
| | Main | Worktree |
|---|---|---|
| Database | `tandem` | `multica_my_feature_702` |
...
```bash
docker compose exec -T postgres psql -U tandem -d postgres \
