---
title: Architecture
description: Technical architecture of the Agora platform.
---

## Overview

Agora is a Go backend + monorepo frontend (pnpm workspaces + Turborepo) with shared packages.
...
- **Entry points** (`cmd/`): `server` (HTTP API), `agora` (CLI + daemon), `migrate`
