 ...
 * yet schematised in @tandem/core/api/schemas. Lenient by design — see the
...
import { IssueSchema } from "@tandem/core/api/schemas";
...
// availability derivation in @tandem/core/agents/derive-presence. All other
...
export const EMPTY_ISSUE_FALLBACK: import("@tandem/core/types").Issue = {
  id: "",
  workspace_id: "",
  number: 0,
  identifier: "",
