 ...
 * yet schematised in @agora/core/api/schemas. Lenient by design — see the
...
import { IssueSchema } from "@agora/core/api/schemas";
...
// availability derivation in @agora/core/agents/derive-presence. All other
...
export const EMPTY_ISSUE_FALLBACK: import("@agora/core/types").Issue = {
  id: "",
  workspace_id: "",
  number: 0,
  identifier: "",
