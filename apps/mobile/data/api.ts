 ...
 *
 * Types are imported via `import type` from @tandem/core/types — zero
 * runtime coupling. Zod schemas + fallbacks are imported from
 * @tandem/core/api/schemas (pure data, on the mobile sharing whitelist).
 *
 ...
 *  reasonable Tandem payload size on cellular. */
