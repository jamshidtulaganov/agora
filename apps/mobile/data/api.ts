 ...
 *
 * Types are imported via `import type` from @agora/core/types — zero
 * runtime coupling. Zod schemas + fallbacks are imported from
 * @agora/core/api/schemas (pure data, on the mobile sharing whitelist).
 *
 ...
 *  reasonable Agora payload size on cellular. */
