...
export const metadata: Metadata = {
  title: "Download Tandem",
  description:
    "Download Tandem for macOS, Windows, or Linux — or install the CLI for servers and remote dev boxes.",
  openGraph: {
    title: "Download Tandem",
    description:
      "Get the Tandem desktop app with a bundled daemon, or install the CLI for servers and remote dev boxes.",
    url: "/download",
  },
  alternates: {
    canonical: "/download",
