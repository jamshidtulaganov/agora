...
/**
 * Server-side fetcher for the latest Agora release, designed to
...
const GITHUB_RELEASES_URL =
  "https://api.github.com/repos/jamshidtulaganov/agora-cli/releases?per_page=2";
...
export async function fetchLatestRelease(): Promise<LatestRelease> {
  ...
  try {
    ...
    // Defensive filter — Agora doesn't publish prereleases or drafts
