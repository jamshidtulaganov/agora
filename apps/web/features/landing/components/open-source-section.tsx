...
export function OpenSourceSection() {
  ...
  return (
    <section id="open-source" className="bg-white text-[#18181B] dark:bg-[#05060b] dark:text-white">
      <div className="mx-auto max-w-[1320px] px-4 py-24 sm:px-6 sm:py-32 lg:px-8 lg:py-40">
        <div className="flex flex-col gap-16 lg:flex-row lg:items-start lg:gap-24">
          ...
          <div className="lg:w-[480px] lg:shrink-0">
            ...
            <p className="mt-6 max-w-[420px] text-[15px] leading-7 text-[#3F3F46] dark:text-white/60 sm:text-[16px]">
          ...
          <div className="flex-1">
            <div className="grid gap-px overflow-hidden rounded-2xl border border-zinc-200 bg-zinc-200 dark:border-white/10 dark:bg-white/10 sm:grid-cols-2">
              {t.openSource.highlights.map((item) => (
                <div key={item.title} className="bg-white p-8 dark:bg-[#05060b] lg:p-10">
                  <h3 className="text-[17px] font-semibold leading-snug text-[#18181B] dark:text-white sm:text-[18px]">
                    {item.title}
                  </h3>
                  <p className="mt-3 text-[14px] leading-[1.7] text-[#3F3F46] dark:text-white/56 sm:text-[15px]">
                    {item.description}
                  </p>
                </div>
              ))}
