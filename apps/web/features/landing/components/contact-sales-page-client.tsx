...
export function ContactSalesPageClient() {
  ...
  return (
    <>
      ...
      <main className="bg-[#f7f8fa] text-[#0a0d12] dark:bg-white/[0.04] dark:text-white">
        <div
          ref={successAnchorRef}
          className="mx-auto max-w-[760px] px-4 py-12 sm:px-6 sm:py-16 lg:py-20"
        >
          <div className="mb-8 text-center">
            <p className="text-[12px] font-semibold uppercase tracking-[0.12em] text-[#0a0d12]/45 dark:text-white/45">
              {c.eyebrow}
            </p>
            <h1 className="mt-2 font-[family-name:var(--font-serif)] text-[2.4rem] leading-[1.1] tracking-[-0.02em] sm:text-[2.8rem]">
              {c.title}
            </h1>
            <p className="mt-3 text-[14px] text-[#0a0d12]/60 sm:text-[15px] dark:text-white/65">
              {c.subtitle}
            </p>
          </div>
...
function SuccessCard({
  ...
  return (
    <div className="rounded-[16px] border border-[#0a0d12]/8 bg-white p-8 shadow-[0_1px_2px_rgba(10,13,18,0.04)] sm:p-10 dark:border-white/10 dark:bg-white/[0.03]">
      <h2 className="font-[family-name:var(--font-serif)] text-[1.8rem] leading-[1.15] tracking-[-0.02em]">
        {title}
      </h2>
      <p className="mt-3 text-[15px] leading-[1.7] text-[#0a0d12]/70 dark:text-white/65">
        {message}
      </p>
      <div className="mt-6">
        <Link
          href="/"
          className="inline-flex items-center gap-2 rounded-[11px] bg-[#0a0d12] px-5 py-2.5 text-[13px] font-semibold text-white transition-colors hover:bg-[#0a0d12]/88 dark:bg-white/[0.04] dark:text-white dark:hover:bg-white/8"
        >
          {cta}
        </Link>
      </div>
...
function FormCard({
  ...
  return (
    <form
      onSubmit={onSubmit}
      className="space-y-8 rounded-[16px] border border-[#0a0d12]/8 bg-white p-6 shadow-[0_1px_2px_rgba(10,13,18,0.04)] sm:p-10 dark:border-white/10 dark:bg-white/[0.03]"
    >
      <div className="rounded-[12px] border border-[#0a0d12]/8 bg-[#f7f8fa] p-4 text-[13px] leading-[1.6] text-[#0a0d12]/72 dark:border-white/10 dark:bg-white/[0.04] dark:text-white/65">
        <p className="font-semibold text-[#0a0d12] dark:text-white">
      ...
      >
        <textarea
          ...
          className="block w-full rounded-[10px] border border-[#0a0d12]/14 bg-white px-3.5 py-2.5 text-[14px] text-[#0a0d12] placeholder:text-[#0a0d12]/35 transition-colors focus:border-[#0a0d12]/40 focus:outline-none focus:ring-2 focus:ring-[#0a0d12]/10 disabled:opacity-60 dark:border-white/12 dark:bg-white/[0.04] dark:text-white dark:placeholder:text-white/40"
        />
      </Field>
...
function Field({
  ...
  return (
    <div className="space-y-1.5">
      <label
        htmlFor={htmlFor}
        className="block text-[13px] font-medium text-[#0a0d12]/82 dark:text-white/65"
      >
        {label}
        ...
        <p
          ...
          className={
            tone === "warning"
              ...
              : "text-[12px] leading-[1.55] text-[#0a0d12]/55 dark:text-white/45"
          }
        >
          {hint}
        </p>
...
function TextInput({
  ...
  return (
    <input
      ...
      className="block w-full rounded-[10px] border border-[#0a0d12]/14 bg-white px-3.5 py-2.5 text-[14px] text-[#0a0d12] placeholder:text-[#0a0d12]/35 transition-colors focus:border-[#0a0d12]/40 focus:outline-none focus:ring-2 focus:ring-[#0a0d12]/10 disabled:opacity-60 aria-[invalid=true]:border-[#c83a3a]/60 aria-[invalid=true]:focus:ring-[#c83a3a]/15 dark:border-white/12 dark:bg-white/[0.04] dark:text-white dark:placeholder:text-white/40"
    />
  );
}
...
function ConsentBlock({
  ...
  return (
    <div className="space-y-3 text-[13px] leading-[1.65] text-[#0a0d12]/70 dark:text-white/65">
      <p className="font-semibold text-[#0a0d12] dark:text-white">{dict.consent.intro}</p>
      <ConsentCheckbox
        id={outreachId}
      ...
      <p>
        ...
        <Link
          ...
          className="text-[#0a0d12] underline decoration-[#0a0d12]/30 underline-offset-2 hover:decoration-[#0a0d12]/60 dark:text-white dark:decoration-white/30 dark:hover:decoration-white/60"
        >
  ...
  return (
    <label htmlFor={id} className="flex items-start gap-2.5">
      <input
        ...
        disabled={disabled}
        className="mt-0.5 size-4 shrink-0 rounded-[4px] border-[#0a0d12]/30 text-[#0a0d12] focus:ring-[#0a0d12]/20 disabled:opacity-60 dark:border-white/10 dark:text-white"
      />
      <span>{label}</span>
    </label>
  );
