...
export function createEnDict(allowSignup: boolean): LandingDict {
  ...
  features: {
    ...
    runtimes: {
      ...
      cards: [
        ...
        },
        {
          ...
          description:
            "Agora scans for 12 supported coding tools \u2014 Antigravity, Claude Code, Codex, Cursor, Copilot, Gemini, Hermes, Kimi, Kiro CLI, OpenCode, OpenClaw, and Pi \u2014 and registers a runtime for each one it finds.",
        },
      ],
    },
    review: {
    ...
    mock: {
      ...
      qaLanePending: "Pending QA",
      qaLanePass: "Passed",
      qaRow1Title: "Payment form validation",
      qaRow1Verdict: "3/5 checks failed — login redirect broken",
      qaRow2Title: "Export reports to CSV & PDF",
      qaRow3Title: "Sprint burndown widget",
      qaRow4Title: "Dashboard date filter",
      qaRow4Verdict: "5/5 passed — screenshots attached",
  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          "Run agora setup \u2014 it walks you through OAuth, starts the daemon, and scans for the 12 supported coding tools (Antigravity, Claude Code, Codex, Cursor, Copilot, Gemini, Hermes, Kimi, Kiro CLI, OpenCode, OpenClaw, Pi). Whichever ones you already have installed get registered as runtimes automatically.",
      },
      {
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Both. You can self-host Agora on your own infrastructure with Docker Compose or Kubernetes, or use our hosted cloud version. Your data, your choice.",
      },
      {
        question:
          "How is this different from just using coding agents directly?",
        answer:
          "Coding agents are great at executing. Agora adds the management layer: task queues, team coordination, skill reuse, runtime monitoring, and a unified view of what every agent is doing. Think of it as the project manager for your agents.",
      },
      {
        question: "Can agents work on long-running tasks autonomously?",
        answer:
          "Yes. Agora manages the full task lifecycle \u2014 enqueue, claim, execute, complete or fail. Agents report blockers proactively and stream progress in real time. You can check in whenever you want or let them run overnight.",
      },
      {
        question: "Is my code safe? Where does agent execution happen?",
        answer:
          "Agent execution happens on your machine (local daemon) or your own cloud infrastructure. Code never passes through Agora servers. The platform only coordinates task state and broadcasts events.",
      },
      {
  ...
  footer: {
    ...
    copyright: "\u00a9 {year} Agora. All rights reserved.",
  },
  ...
  changelog: {
    title: "Changelog",
    subtitle: "New updates and improvements to Agora.",
    toc: "All releases",
    categories: {
    ...
    entries: [
      {
        ...
        changes: [],
        features: [
          "CodeBuddy can now run local Agora agents, with its available model and effort choices shown automatically",
      ...
      },
      {
        ...
        features: [
          ...
          "Claude Fable 5 is now available in Agora's supported model and pricing list",
          ...
          "Lark and Feishu conversations now show a typing reaction while Agora is preparing a reply, then clear it before the answer is sent",
          "Agent runs now know who started each task, making handoffs, audit trails, and privacy-aware behavior more accurate",
          "OpenClaw users can point Agora at a custom app location and data folder from their local configuration",
        ],
        improvements: [
          "Comment trigger indicators are quieter, clearer, and less likely to crowd long agent names",
          "Desktop now disables daemon start and stop controls when the daemon is managed outside Agora, such as in WSL2",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "The web app can now show native browser notification banners, making workspace activity easier to catch while Agora is in the background",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Agora now supports Lark as a third-party integration, so teams can scan a QR code and create a Agora agent as a Lark Bot",
          ...
          "Agents now include built-in Agora skills so they can follow workspace workflows more consistently",
        ],
        improvements: [
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Agora now supports Japanese across the app, site, and docs",
      ...
      },
      {
        ...
        features: [
          ...
          "Agora now supports Korean across the app, public site, and documentation, including Korean docs pages and localized date formatting",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Projects can now use a local working directory on Desktop, so tasks can run in an existing folder while Agora shows when another task is waiting for that directory",
      ...
      },
      {
        version: "0.3.8",
        date: "2026-05-25",
        title: "Agora for iOS, Helm Self-Hosting & Smoother Collaboration",
        changes: [],
        features: [
          "Agora for iOS is now available as our first official usable mobile client, covering login, workspaces, inbox, Issues, projects, chat, comments, reactions, presence, and live updates; it is not on the App Store yet, so users need to build and install it manually",
          "Self-hosted teams can now deploy Agora to Kubernetes with a Helm chart, while Docker-based installs keep clearer port and URL controls",
        ...
        fixes: [
          ...
          "Codex runs no longer inherit hidden host memory during Agora tasks, and Pi runs receive a cleaner end-of-input signal",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "New users now enter a guided welcome experience where Agora Helper can introduce the workspace, give a tour, or build a slide-style welcome page",
      ...
      },
      {
        ...
        improvements: [
          ...
          "GitHub-linked pull requests now surface CI and merge-conflict status inside Agora",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Connect GitHub so linked pull requests appear on Agora issues, sync their status, and close the Agora issue automatically when the PR closes",
        ...
        improvements: [
          ...
          "Linux desktop packages show the Agora app icon again",
        ],
        fixes: [
      ...
      },
      {
        ...
        fixes: [
          ...
          "Windows / Linux desktop replaces the Electron placeholder icon with the Agora asterisk",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "`agora repo checkout --ref` targets a branch, tag, or specific commit when pulling a repo into the workspace",
          "`agora agent avatar` uploads an agent avatar straight from the CLI",
        ...
        fixes: [
          ...
          "`agora login --token <PAT>` accepts the PAT as a flag value instead of rejecting it",
      ...
      },
      {
        ...
        improvements: [
          ...
          "Agora Agent commits include a `Co-authored-by` trailer for proper Git attribution",
      ...
      },
      {
        ...
        improvements: [
          ...
          "Backend default agent CLI args via `AGORA_CLAUDE_ARGS` / `AGORA_CODEX_ARGS` env vars",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "`agora agent create/update --custom-env KEY=VALUE` injects custom environment variables into agent runs",
          "Agent failure messages now include a tail of the runtime CLI's stderr — much easier to debug runtime errors",
          "CLI update download timeout is now configurable, so slow links no longer abort `agora update`",
        ],
        improvements: [
      ...
      },
      {
        ...
        features: [
          ...
          "`agora update` self-update command — upgrade the CLI and local daemon without reinstalling",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Per-agent `model` field with a provider-aware dropdown — pick the LLM model for each agent from the UI or via `agora agent create/update --model`, with live discovery from each runtime's CLI",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "One-click install & setup — `curl | bash` installs CLI, `--with-server` bootstraps full self-hosting, `agora setup` configures your environment",
      ...
      },
      {
        ...
        changes: [
          ...
          "Daemon ensures agora CLI is on PATH in agent task environment",
  ...
  download: {
    ...
    cli: {
      ...
      installUnixLabel: "Install — macOS / Linux",
      installWindowsLabel: "Install — Windows (PowerShell)",
  ...
  contactSales: {
    ...
    fields: {
      ...
      useCase: "How do you plan to use or collaborate with Agora?",
      goals: "Your goals or challenges",
      goalsHint:
        "Tell us what you’d like to achieve with Agora or the challenges you’re facing. The more details you provide, the better we can support you.",
    ...
    useCases: [
      { value: "evaluate", label: "Evaluating Agora for my team" },
      { value: "adopt_team", label: "Rolling out Agora to a team or company" },
      { value: "self_host", label: "Self-hosting on our own infrastructure" },
      { value: "integrate", label: "Integrating Agora with existing tools" },
    ...
    consent: {
      intro:
        "Agora, Inc. respects your privacy. We’ll use your personal information only to manage your account and deliver the products or services you’ve requested. Occasionally, we’d love to share product updates, best practices, and insights that may be relevant to you. Please let us know below if you’d like to hear from us.",
      outreach:
        "I’d like to receive one-to-one communication from Agora, Inc., including service updates, support inquiries, and business-related follow-ups.",
      updates:
        "I’d like to receive product updates, insights, and event invitations from Agora.",
      unsubscribe:
      ...
      submitConsent:
        "By clicking “Submit,” you consent to allow Agora, Inc. to store and process your information for the purpose of delivering the requested content.",
