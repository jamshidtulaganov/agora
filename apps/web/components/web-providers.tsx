...
// cookie mode on their next logout/login cycle (logout clears agora_token).
// Sunset: once telemetry shows <1% of sessions still carry agora_token,
...
function hasLegacyToken(): boolean {
  ...
  try {
    return Boolean(window.localStorage.getItem("agora_token"));
  } catch {
    return false;
  }
}
