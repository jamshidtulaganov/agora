...
import { createBrowserCookieLocaleAdapter } from "@tandem/core/i18n/browser";
import type { LocaleResources, SupportedLocale } from "@tandem/core/i18n";
...
// cookie mode on their next logout/login cycle (logout clears tandem_token).
// Sunset: once telemetry shows <1% of sessions still carry tandem_token,
...
function hasLegacyToken(): boolean {
  ...
  try {
    return Boolean(window.localStorage.getItem("tandem_token"));
  } catch {
    return false;
  }
}
