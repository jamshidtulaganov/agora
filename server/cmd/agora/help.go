...
var rootHelpTemplate = `Work seamlessly with Agora from the command line.

USAGE
  agora <command> <subcommand> [flags]
{{range .Groups}}
{{.Title}}
...
EXAMPLES
  ...
  $ agora daemon start
  $ agora agent list --output json

ENVIRONMENT VARIABLES
  AGORA_SERVER_URL    Override the default server URL
  AGORA_WORKSPACE_ID  Set the active workspace

LEARN MORE
  Use ` + "`agora <command> <subcommand> --help`" + ` for more information about a command.
`
