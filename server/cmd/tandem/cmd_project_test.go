...
// review round 2: `tandem project resource update <p> <r> --default-branch-hint x`
...
func TestBuildResourceRefFromFlagsGithubMergesHint(t *testing.T) {
	...
	t.Run("url override survives merge", func(t *testing.T) {
		cmd := newProjectResourceUpdateTestCmd()
		_ = cmd.Flags().Set("url", "https://github.com/tandem-ai/new-repo")
		existing := map[string]any{
			"url":                 "https://github.com/multica-ai/multica",
		...
		if ref["url"] != "https://github.com/tandem-ai/new-repo" {
