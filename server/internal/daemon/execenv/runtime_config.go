...
func buildMetaSkillContent(provider string, ctx TaskContextForEnv) string {
	...
	// Review-request formatting stays neutral and human-owned. Providers have
	// occasionally appended their own attribution or Agora backlink footer to a
	// PR/MR body, creating noisy boilerplate on every change. Issue linkage is
	// already carried by the branch/title/task metadata, so prohibit both forms
	// platform-wide instead of relying on provider-specific settings.
	b.WriteString("## Pull/Merge Request Formatting\n\n")
	b.WriteString("Keep pull-request and merge-request titles and bodies focused on the change, verification, and reviewer-relevant risks. Do NOT add an Agora issue backlink/footer (for example `Agora: SD-25 (...)`). Do NOT add AI/provider attribution such as `Generated with Claude Code`, `Generated by AI`, or automated `Co-Authored-By` attribution.\n\n")
