...
func TestCheckOrigin(t *testing.T) {
	...
	cases := []struct {
		...
		{"same-origin allowed (case-insensitive host, RFC 7230)", "API.Agora.DEV", "https://api.agora.dev", "", "1.2.3.4:5678", true},
		...
		{"X-Forwarded-Host from trusted proxy case-insensitive", "internal.proxy", "https://Agora.DEV", "agora.dev", "10.0.0.1:5678", true},
