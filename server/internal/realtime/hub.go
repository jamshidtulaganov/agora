...
// loadTrustedProxies reads the same TANDEM_TRUSTED_PROXIES env var the rest of
...
func loadTrustedProxies() []netip.Prefix {
	raw := strings.TrimSpace(os.Getenv("TANDEM_TRUSTED_PROXIES"))
	if raw == "" {
		return nil
	}
...
// shared TANDEM_TRUSTED_PROXIES value in here at startup.
