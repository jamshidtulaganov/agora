...
// loadTrustedProxies reads the same AGORA_TRUSTED_PROXIES env var the rest of
...
func loadTrustedProxies() []netip.Prefix {
	raw := strings.TrimSpace(os.Getenv("AGORA_TRUSTED_PROXIES"))
	if raw == "" {
		return nil
	}
...
// shared AGORA_TRUSTED_PROXIES value in here at startup.
