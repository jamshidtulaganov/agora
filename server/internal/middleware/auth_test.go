...
func TestAuth_ValidToken(t *testing.T) {
	...
	if gotEmail != "test@tandem.dev" {
		t.Fatalf("expected X-User-Email 'test@tandem.dev', got '%s'", gotEmail)
	}
}
...
// as the daemon side: with no TANDEM_CLOUD_FLEET_URL configured, an
