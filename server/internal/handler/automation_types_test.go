...
func TestValidateAutomationRule(t *testing.T) {
	...
	cases := []struct {
		...
		{"webhook needs a connector", automationTriggerStatusChanged, nil,
			[]automationAction{{Type: automationActionSendWebhook, Config: map[string]string{}}}, true},
		{"webhook rejects a malformed connector id", automationTriggerStatusChanged, nil,
			[]automationAction{{Type: automationActionSendWebhook, Config: map[string]string{"integration_id": "nope"}}}, true},
		{"webhook accepts a connector id", automationTriggerStatusChanged, nil,
			[]automationAction{{Type: automationActionSendWebhook, Config: map[string]string{"integration_id": "00000000-0000-0000-0000-000000000001"}}}, false},
