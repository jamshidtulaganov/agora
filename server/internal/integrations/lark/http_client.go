...
const (
	...
	// Operators do NOT set AGORA_LARK_HTTP_BASE_URL to pick a cloud
	...
	// latency from a self-hosted Agora deployment to feishu.cn.
...
func (c HTTPClientConfig) withDefaults() HTTPClientConfig {
	...
	// non-empty BaseURL (AGORA_LARK_HTTP_BASE_URL, or an httptest URL
...
// keyed by app_id so a single Agora server reuses Lark's
...
// cfg.BaseURL (AGORA_LARK_HTTP_BASE_URL, or an httptest URL in tests)
