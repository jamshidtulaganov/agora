...
//     and an expiry. Tandem renders the QR, the user scans it in the
...
type RegistrationConfig struct {
	...
	// telemetry can attribute installs back to Tandem. Empty defaults
	// to "tandem".
	Source string
...
type BeginResult struct {
	DeviceCode string
	// QRCodeURL is the verification_uri_complete with Tandem's `source`
...
// "<agent> - Tandem" instead of Lark's auto-generated
...
// cannot attribute installs back to Tandem in their analytics.
//
