...
//     and an expiry. Agora renders the QR, the user scans it in the
...
type RegistrationConfig struct {
	...
	// telemetry can attribute installs back to Agora. Empty defaults
	// to "agora".
	Source string
...
type BeginResult struct {
	DeviceCode string
	// QRCodeURL is the verification_uri_complete with Agora's `source`
...
// "<agent> - Agora" instead of Lark's auto-generated
...
// cannot attribute installs back to Agora in their analytics.
//
