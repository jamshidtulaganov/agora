...
// (Tandem Cloud Node) PAT. Tokens with this prefix are validated by
// calling the Tandem Cloud Fleet service rather than by hitting our
...
// TANDEM_CLOUD_FLEET_URL configured simply rejects mcn_ tokens at
...
type CloudPATVerifierConfig struct {
	...
	// https://fleet.tandem.cloud). Trailing slashes are trimmed.
