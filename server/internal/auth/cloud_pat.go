...
// (Agora Cloud Node) PAT. Tokens with this prefix are validated by
// calling the Agora Cloud Fleet service rather than by hitting our
...
// AGORA_CLOUD_FLEET_URL configured simply rejects mcn_ tokens at
...
type CloudPATVerifierConfig struct {
	...
	// https://fleet.agora.cloud). Trailing slashes are trimmed.
