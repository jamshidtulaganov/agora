...
This file records source evidence for `tandem-squads/SKILL.md`.
...
```text
server/cmd/tandem/cmd_squad.go
```
...
```bash
tandem squad list
tandem squad get <squad-id>
tandem squad create
tandem squad update <squad-id>
tandem squad delete <squad-id>
tandem squad activity <issue-id> <outcome>

tandem squad member list <squad-id>
tandem squad member add <squad-id>
tandem squad member remove <squad-id>
