...
const EMPTY_DAILY: import("@agora/core/types").DashboardUsageDaily[] = [];
const EMPTY_BY_AGENT: import("@agora/core/types").DashboardUsageByAgent[] = [];
const EMPTY_RUNTIME: import("@agora/core/types").DashboardAgentRunTime[] = [];
const EMPTY_RUNTIME_DAILY: import("@agora/core/types").DashboardRunTimeDaily[] = [];
