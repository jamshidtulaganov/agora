...
import type { AgentRuntime, MemberWithUser } from "@agora/core/types";
import { deriveWorkload } from "@agora/core/agents";
import {
  deriveRuntimeHealth,
  runtimeUsageOptions,
...
function CliCell({ runtime }: { runtime: AgentRuntime }) {
  ...
  // The separate `cli_version` is the shared agora daemon CLI, identical
