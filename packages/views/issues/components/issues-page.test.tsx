...
// Mock @agora/views/navigation (AppLink + useNavigation)
vi.mock("../../navigation", () => ({
...
vi.mock("@agora/core/issues/stores/view-store", () => ({
...
vi.mock("@agora/core/issues/stores/view-store-context", () => ({
...
vi.mock("@agora/core/issues/stores/issues-scope-store", () => ({
...
vi.mock("@agora/core/issues/stores/selection-store", () => ({
...
vi.mock("@agora/core/issues/stores/recent-issues-store", () => ({
