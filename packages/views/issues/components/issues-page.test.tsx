...
// Mock @tandem/views/navigation (AppLink + useNavigation)
vi.mock("../../navigation", () => ({
...
vi.mock("@tandem/core/issues/stores/view-store", () => ({
...
vi.mock("@tandem/core/issues/stores/view-store-context", () => ({
...
vi.mock("@tandem/core/issues/stores/issues-scope-store", () => ({
...
vi.mock("@tandem/core/issues/stores/selection-store", () => ({
...
vi.mock("@tandem/core/issues/stores/recent-issues-store", () => ({
