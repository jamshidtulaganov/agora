...
import {
  ...
  CollapsibleContent,
  CollapsibleTrigger,
} from "@agora/ui/components/ui/collapsible";
import {
  Tooltip,
  TooltipTrigger,
  TooltipContent,
...
import type { ChatMessage, ChatPendingTask, TaskFailureReason } from "@agora/core/types";
...
function TimelineView({
  ...
  isStreaming?: boolean;
  attachments?: import("@agora/core/types").Attachment[];
}) {
