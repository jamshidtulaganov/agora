...
import { useWorkspacePaths, useWorkspaceSlug } from "@agora/core/paths";
...
import { isAllowedFileCardHref } from "@agora/ui/markdown";
...
const AGENT_MACHINE_FENCE =
  /(^|\n)[ \t]*```(?:qa-result|design-proposal|design-context|design-manifest|test-cases|knowledge-items|qa-manifest)[ \t]*\n[\s\S]*?\n[ \t]*```[ \t]*(?=\n|$)/g;
