...
import type { Agent, MemberWithUser, Squad } from "@tandem/core/types";
...
vi.mock("@tandem/ui/components/ui/input", () => ({
  Input: (props: React.InputHTMLAttributes<HTMLInputElement>) => (
    <input {...props} />
  ),
}));

vi.mock("@tandem/ui/components/ui/label", () => ({
