...
import type { Agent, MemberWithUser, Squad } from "@agora/core/types";
...
vi.mock("@agora/ui/components/ui/input", () => ({
  Input: (props: React.InputHTMLAttributes<HTMLInputElement>) => (
    <input {...props} />
  ),
}));

vi.mock("@agora/ui/components/ui/label", () => ({
