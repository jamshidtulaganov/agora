...
export const projectKeys = {
  ...
  config: (wsId: string, id: string) =>
    [...projectKeys.detail(wsId, id), "config"] as const,
};
...
export function projectConfigOptions(wsId: string, id: string) {
  return queryOptions({
    queryKey: projectKeys.config(wsId, id),
