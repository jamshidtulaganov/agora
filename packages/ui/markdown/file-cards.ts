 ...
 *
 * Uses exact hostname match against `cdnDomain` (e.g. "agora-static.copilothub.ai"),
 ...
 * @param cdnDomain CDN hostname for legacy link detection (e.g. "agora-static.copilothub.ai")
 */
