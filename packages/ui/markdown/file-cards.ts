 ...
 *
 * Uses exact hostname match against `cdnDomain` (e.g. "tandem-static.copilothub.ai"),
 ...
 * @param cdnDomain CDN hostname for legacy link detection (e.g. "tandem-static.copilothub.ai")
 */
